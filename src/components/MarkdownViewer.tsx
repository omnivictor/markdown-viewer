            ...
            components={{
              ...
              table: ({ children, ...props }) => (
                <div className="overflow-x-auto my-6 rounded-md border" style={{ borderColor: v.border }}>
                  <table className="min-w-full divide-y" style={{ borderColor: v.border, backgroundColor: v.bg }} {...props}>{children}</table>
                </div>
              ),
              ...
              th: ({ children, ...props }) => (
                <th className="px-6 py-3 text-left text-xs font-semibold" style={{ color: v.text }} {...props}>{children}</th>
              ),
